...
//at the time of app installation run methode is executed and index.json file data is read.
  @Override
  public void run ()
  {
    InputStream is = null;
    ...
    try
    {
      ...
      //this GsonBuilder is simply used to create the gson instance.
      GsonBuilder gsonBuilder = new GsonBuilder();
      gsonBuilder.setFieldNamingPolicy(FieldNamingPolicy.UPPER_CAMEL_CASE);
      Gson gson = gsonBuilder.create();
    /*  Type collectionTypea = new TypeToken<Collection<MasterDataPojo>>(){}.getType();
      Collection<MasterDataPojo> masterPojo = gson.fromJson(builder.toString(), collectionTypea);*/
      //MasterDataPojo masterPojo = gson.fromJson(builder.toString(), collectionTypea);
