...
import sg.totalebizsolutions.genie.databinding.CategoriesFragmentBinding;
import sg.totalebizsolutions.genie.databinding.CategoryItemBinding;
...
public class CategoriesFragment extends NavigationItemFragment
{
  ...
  private class InternalRecyclerAdapter extends RecyclerView.Adapter
  {
    ...
    public void onBindViewHolder (RecyclerView.ViewHolder holder, int position)
    {
      ...
      {
        category = CategoryMetaData.CATEGORIES[position];
