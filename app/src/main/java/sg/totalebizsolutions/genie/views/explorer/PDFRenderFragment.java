...
public class PDFRenderFragment extends Fragment {
    ...
    public static PDFRenderFragment newInstance(int file) {
        PDFRenderFragment fragment = new PDFRenderFragment();
        Bundle args = new Bundle();
        args.putInt(BUNDLE_FILE, file);
  ...
  /* Life-cycle methods */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_file = args.getInt(BUNDLE_FILE);
         resourceId = this.getResources().getResourceEntryName(m_file);
        try {
            openRenderer(PDFRenderFragment.this.getActivity());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void openRenderer(Activity activity) throws IOException {
        ...
        fileDescriptor = res.openRawResourceFd(m_file).getParcelFileDescriptor();
