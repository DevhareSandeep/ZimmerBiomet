...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
			...
			if (Intent.ACTION_VIEW.equals(intent.getAction())) {
				...
				if (uri.toString().startsWith("content://")) {
					...
					if (reason != null) {
						...
						setTitle(String.format(res.getString(com.artifex.mupdfdemo.R.string.cannot_open_document_Reason), reason));
	...
	private void showInfo(String message) {
		...
		if (currentApiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
			SafeAnimatorInflater safe = new SafeAnimatorInflater((Activity)this, com.artifex.mupdfdemo.R.animator.info, (View)mInfoView);
		} else {
	...
	private void makeButtonsView() {
		mButtonsView = getLayoutInflater().inflate(com.artifex.mupdfdemo.R.layout.buttons,null);
